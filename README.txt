...
1. final_combed_set.csv: the final combed CSV that contains all of the data that we will run machine learning analysis on. This is the result of the code that was run in the all_py/ folder. It is good to note that this file IS NOT INCLUDED in the Github, as it is too large and is derived from the Zinc and Coconut databases with the Python files we describe above.
